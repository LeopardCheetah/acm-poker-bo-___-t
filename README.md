...
readme / past commits are from the forked off `poker-bot-starter-code` repo that was provided as a template/library to use to code the poker bot.
...
## Important
- Please submit your code before **11:59 PM on November 14, 2025**, late submissions will not be accepted.
...
- We only allow some standard Python libraries. No external libraries allowed.
